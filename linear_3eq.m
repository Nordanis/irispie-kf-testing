...
databank.toSheet(f.Smooth.Mean, "test/out0_3eq_mean_mat.csv", includeComments=false);
databank.toSheet(f.Smooth.Std, "test/out0_3eq_std_mat.csv", includeComments=false);
...
% figure; plot(range, [f.Smooth.Mean.y f.Smooth.Mean.y_tnd], "LineWidth", 2); grid on; legend("Level", "Trend");
databank.toSheet(f.Smooth.Mean, "test/out1_3eq_mean_mat.csv", includeComments=false);
databank.toSheet(f.Smooth.Std, "test/out1_3eq_std_mat.csv", includeComments=false);
...
% figure; plot(range, [f.Smooth.Mean.y f.Smooth.Mean.y_tnd], "LineWidth", 2); grid on; legend("Level", "Trend");
databank.toSheet(f.Smooth.Mean, "test/out2_3eq_mean_mat.csv", includeComments=false);
databank.toSheet(f.Smooth.Std, "test/out2_3eq_std_mat.csv", includeComments=false);
...
% figure; plot(range, [f.Smooth.Mean.y f.Smooth.Mean.y_tnd], "LineWidth", 2); grid on; legend("Level", "Trend");
databank.toSheet(f.Smooth.Mean, "test/out3_3eq_mean_mat.csv", includeComments=false);
databank.toSheet(f.Smooth.Std, "test/out3_3eq_std_mat.csv", includeComments=false);
